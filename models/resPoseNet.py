...
def define_network(input_nc, model, init_from=None, isKD=False, isTest=False, gpu_ids=[]):
    ...
    if model == 'resnet18':
        netG = ResNet18(3, ResBlock, weights=init_from, isKD=isKD)

    elif model == 'resnet34':
        netG = ResNet34(3, ResBlock, weights=init_from, isKD=isKD)

    elif model == 'resnet50':
        netG = ResNet50(3, ResBottleneckBlock, weights=init_from, isKD=isKD)

    elif model == 'resnet101':
        netG = ResNet101(3, ResBottleneckBlock, weights=init_from, isKD=isKD)
